...
const openai = new OpenAI({
  apiKey:"sk-proj-HAQOhcl4FZ3pvoAyZW8PT3BlbkFJZ9UGPV8KPGEwaKgl3kEy",
});
...
No need to write any reason, just give the number. Only and only number, don't say any reason. \n\n${prompt}`,
            },
          ],
          temperature: 0.7,
          max_tokens: 5,
